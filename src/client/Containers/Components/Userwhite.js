...
const SvgUserwhite = props => (
    <svg viewBox="0 0 489.7 489.7" width={250} height={250} {...props}>
        <circle
            cx={244.9}
            cy={47}
            r={37.8}
            data-original="#A7A9AC"
            data-old_color="#A7A9AC"
            fill="#63c3d1"
        />
        <circle
            cx={417.3}
